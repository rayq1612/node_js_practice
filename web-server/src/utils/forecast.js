...
const forecast = (units, lang, lat, lon, callback) => {
    ...
    request({ url: url, json: true}, (error, {body}) => {
        if (error) {
            ...
            callback(undefined, {
                forecastData: "Today is " + body.current.weather[0].main + ". It is currently " + body.current.temp + " degress out and if feels like " + body.current.feels_like + " degress out. Wind speed is " + body.current.wind_speed + " m/s."
